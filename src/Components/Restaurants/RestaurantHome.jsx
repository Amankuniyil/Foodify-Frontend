      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
               ...
               <span class="self-center whitespace-nowrap">foodify</span>
               </a>
                  ...
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                        <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <NavLink to="/Restaurant/addfood" className="flex items-center p-2 space-x-3 rounded-md">
                           <span class="ml-3 flex-1 whitespace-nowrap">Add Food</span>
                           </NavLink>
                     ...
                     <li>
                        <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <NavLink to="/Restaurant/resorders" className="flex items-center p-2 space-x-3 rounded-md">
                     ...
                     <li>
                        <a href="#" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           ...
                           <NavLink to="/Restaurant/menu" className="flex items-center p-2 space-x-3 rounded-md">
            ...
            <div class="pt-6 px-4">
               <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                  <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                     ...
                     <div id="main-chart"><ResChart /></div>
                  </div>
