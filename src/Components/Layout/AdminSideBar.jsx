                ...
                <div className="bg-yellow-200">
                    ...
                    <div className="flex-1">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li className="rounded-sm">
    <NavLink to="/admin/users" className="flex items-center p-2 space-x-3 rounded-md">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-6 h-6 text-gray-100"
            fill="none"
        ...
        <span className="text-gray-100">User Management</span>
                            ...
                            <li className="rounded-sm">
                            <NavLink to="/admin/restaurants" className="flex items-center p-2 space-x-3 rounded-md">
                                <a
                                    href="#"
                                    className="flex items-center p-2 space-x-3 rounded-md"
                                >
                            ...
                            <li className="rounded-sm">
                            <NavLink to="/admin/orders" className="flex items-center p-2 space-x-3 rounded-md">
                                <a
                                    href="#"
                                    className="flex items-center p-2 space-x-3 rounded-md"
                                >
                             ...
                             <li className="rounded-sm">
                             <NavLink to="/admin/chart" className="flex items-center p-2 space-x-3 rounded-md">
                                <a
                                    href="#"
                                    className="flex items-center p-2 space-x-3 rounded-md"
                                >
